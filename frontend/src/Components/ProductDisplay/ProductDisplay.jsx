    ...
    <div className="productdisplay">
      ...
      <div className="productdisplay-right">
        ...
        <div className="productdisplay-right-description">
          ...
          labore, dicta porro iusto dolorem, quibusdam repellendus eos
          voluptatem quod laborum, temporibus optio! Placeat accusamus nesciunt
          ab, totam quos repellendus?
        </div>
        ...
        <button
          ...
          className="openModel btn"
        >
          ADD TO CART
        </button>
        <button className="btn" onClick={() => setShowPopup(true)}>Place Order</button>
        <OrderForm
          loading={loading}
          showPopup={showPopup}
